...
# Now, analyses with data from different projects shall be created to create further insight
...
# Exampmle 1 performed and subsequently plotted in the JH's PhD thesis style
