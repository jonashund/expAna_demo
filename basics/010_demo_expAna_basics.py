...
# Run the documentation function from the ./tex directory
os.chdir("./tex")
...
# Option 2: Use the Istra4D acquisition data containing the raw image data, perform digital image correlation with µDIC, and compute the stresses with expAna
...
# `experiment_list` (only perform the operations for the experiments in the list)
...
# Example for clipping of curves to exclude crude DIC data after specimen failure
